    ...
    const handleCreateUser = (event) => {
        ...
        instance.post('user/create', forms)
            ...
            .catch(err => {
                ...
                setError({ message: 'Terjadi kesalahan saat membuat user. Silakan coba lagi.' });

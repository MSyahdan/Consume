...
export default function Dashboard() {
    ...
    const [lendings, setLendings] = useState([]); // State for lendings
    ...
    function getDataLendings(){
        ...
        .then(res => {
            ...
            setLendings(data); // Set lendings data to state
            setLandingData(data);
            ...
            <div className="flex flex-wrap justify-center m-10">
                ...
                <div className="p-4 w-1/3"> {/* Adjusted width to fit three columns */}
                    <div className="flex rounded-lg h-full dark:bg-gray-800 bg-teal-400 p-8 flex-col">
                        ...
                        <div className="flex flex-col justify-between flex-grow">
                            <h1 className="text-white dark:text-white text-lg font-medium">{landing.length}</h1>
                        </div>
                    </div>
                </div>
